		...
		<Card class="w-full max-w-sm">
			<CardHeader>
				...
				<CardDescription class="text-center"
					>Register to use URLify</CardDescription
				>
			</CardHeader>
			...
			<CardFooter class="flex flex-column">
				<Button class="w-full" type="submit" >Sign In</Button><br>
                <!-- <Button class="w-full" variant="secondary" >  Login Instead </Button> -->
			</CardFooter>
